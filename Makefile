...
BASE_PACKAGE_NAME := github.com/radu-matei/brigade-vsts-gateway
...
redeploy:
	kubectl delete `kubectl get po -l app=github-app-test-brigade-vsts-gateway -o name`
	@echo 'Waiting for pod to start... (20 seconds)'
	sleep 20
	kubectl logs -f `kubectl get po -l app=github-app-test-brigade-vsts-gateway -o name | tail -n 1 | sed 's/pod\///'`
